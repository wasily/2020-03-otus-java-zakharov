...
Parallel:
-Xmx250m -Xms250m -Xlog:gc -XX:+UseParallelGC -Xlog:gc=debug:file=./logs/gc-%p-%t.log:tags,uptime,time,level -XX:+PrintCommandLineFlags
-Xmx7500m -Xms7500m -Xlog:gc -XX:+UseParallelGC -Xlog:gc=debug:file=./logs/gc-%p-%t.log:tags,uptime,time,level -XX:+PrintCommandLineFlags
